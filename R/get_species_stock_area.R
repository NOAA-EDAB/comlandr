...
#'
#'The default sql statement "\code{select * from STOCKEFF.V_CF_STOCK_RECENT_STAT_AREA_O}" is used
#'
#'@section Reference:
...
get_species_stock_area <- function(channel, species = "all", stock_name = NULL){
  ...
  sqlStatement <- dbutils::create_sql(species,fieldName="species_itis",fieldName2=nameType,dataType="%06d",defaultSqlStatement="select * from STOCKEFF.V_CF_STOCK_RECENT_STAT_AREA_O")
