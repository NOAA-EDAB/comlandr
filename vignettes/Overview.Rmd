...
* Commercial landings are pulled from the Stock Efficiency Initiative [(STOCKEFF)](https://apps-st.fisheries.noaa.gov/confluence/spaces/STOCKEFFDOC/pages/246776079/StockEff+for+NEFSC+Users). A product created and maintained by the NEFSC population dynamics branch.
