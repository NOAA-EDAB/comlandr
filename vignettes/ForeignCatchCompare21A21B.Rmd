...
```{r plotspatial, echo=F, eval=T, message=F, fig.alt = "Spatial domain"}
################################################################################
########################## plot spatial domain ################################
################################################################################
options(warn=-1)
...
```{r plot21adiv, echo = F, eval = T, message = F, fig.alt = "Catch by Division 21A"}
...
```{r plot21bdiv, echo = F, eval = T, message = F, fig.alt = "Catch by Division 21B"}
### 21B
...
### 21A
```{r plot21acountry, echo = F, eval = T, message = F, fig.alt = "Catch by Country 21A"}
## By Division
## aggregate over Division
...
```{r plot21bcountry, echo = F, eval = T, message = F, fig.alt = "Catch by Country 21B"}
### 21B
...
```{r plot21aspecies, echo = F, eval = T, message = F, fig.alt = "Catch by Species 21A"}
das <- db21a %>%
...
```{r plot21bspecies, echo = F, eval = T, message = F, fig.alt = "Catch by Species 21B"}
dbs <- db21b %>%
    tidyr::separate(.,col=Speciesname,into=c("spName","spCode"),sep=" - ") %>%
    dplyr::group_by(Year,spCode) %>%
    dplyr::summarise(Mt = sum(MetricTonnes),.groups="drop")
...
```{r plot21atime, echo = F, eval = T, message = F, fig.alt = "Catch by Time 21A"}
...
```{r plot21btime, echo = F, eval = T, message = F, fig.alt = "Catch by Time 21B"}
### 21B
...
```{r unknown21a, echo = F, eval = T,message = F, fig.alt = "Catch Unknowns 21A"}
...
```{r unknown21b, echo = F, eval = T,message = F, fig.alt = "Catch Unknowns 21B"}
