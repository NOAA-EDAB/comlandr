...
divCodes <- readr::read_csv(unz(temp,"NAFO-21B-2010-18/divisions.txt"),col_names = F,show_col_types = F) %>%
...
countryCodes <- readr::read_delim(unz(temp, "NAFO-21B-2010-18/country.txt"),delim = "\t",show_col_types = F) %>%
